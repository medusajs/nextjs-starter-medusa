    ...
    <section className="w-full bg-black py-16">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          <h2 className="size-3xl text-white font-bold">Featured Products</h2>
        ...
        <div className="relative">
          <div className="flex gap-6 justify-center items-center">
            {visibleProducts.map((product, index) => (
              <Card key={index} className="w-[300px] overflow-hidden transition-transform hover:scale-105 relative">
                {product.discount && (
...
// export default function productn({ countryCode }: { countryCode: string }) {
...
//               <Link key={product.id} href="/store" className="group">
//                 <Card className="relative border rounded-lg shadow-md bg-gray-100 overflow-hidden transition-all duration-300 hover:shadow-xl cursor-pointer">
...
//                   <CardContent className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
...
//                           key={index}
//                           size={16}
//                           className={`mr-1 ${index < Math.round(product.rating) ? 'text-yellow-400' : 'text-gray-400'}`}
//                         />
//                       ))}
//                     </div>
//                   </CardContent>
