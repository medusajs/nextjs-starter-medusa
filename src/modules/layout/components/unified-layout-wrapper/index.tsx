    ...
    return (
        <div
            ...
            style={{
                ...
                transition: `margin-right ${(isOpen ? MotionDurations.enter.base : MotionDurations.exit.fast) * 1000
                    }ms ${isOpen ? `cubic-bezier(${MotionEasings.enter.standard.join(',')})` : `cubic-bezier(${MotionEasings.exit.standard.join(',')})`
                    }, margin-left ${((left.isOpen && !left.isMobile) ? MotionDurations.enter.base : MotionDurations.exit.fast) * 1000
                    }ms ${left.isOpen && !left.isMobile ? `cubic-bezier(${MotionEasings.enter.standard.join(',')})` : `cubic-bezier(${MotionEasings.exit.standard.join(',')})`
                    }`
            } as React.CSSProperties}
        >
            {/* Main content area */}
